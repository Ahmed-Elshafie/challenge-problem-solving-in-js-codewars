...
// Check on the sequence to check if empty // Check if the sequence is Array or not
// If the sequence is string, convert it to array // Store the first Value
// Loop through the sequence
// Start the Comparing
// Check of the current letter
// if current not equal the previous, push it to the store // return the final result
